...
set app=%%a
if !app! NEQ 20210306 (echo 发现新版本程序: !app!&echo 更新地址: !url!&title 更新后才可以使用&echo 按任意键退出程序&pause>nul&exit)
)
del data.txt
...
curl --ipv4 --resolve service.udpfile.com:443:!anycast! --retry 3 -s -X POST -d "20210306-!anycast!-!max!" https://service.udpfile.com?asn=%asn%^&city=%city% -o data.txt
